...
par(mfrow = c(2,2))
plot(hpc_sub$Global_active_power ~ hpc_sub$Date_Time, ylab = "Global Active Power", xlab = "", type = "l")
plot(hpc_sub$Voltage ~ hpc_sub$Date_Time, ylab = "Voltage", xlab = "datetime", type = "l")
...
plot(hpc_sub$Global_reactive_power ~ hpc_sub$Date_Time, ylab = "Global_reactive_power", xlab = "datetime", type = "l")
